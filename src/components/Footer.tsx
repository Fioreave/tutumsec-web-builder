      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8 lg:mb-12">
          ...
          <div className="col-span-1">
            <h4 className="text-base lg:text-lg font-semibold mb-4 lg:mb-6 text-white">Servicios</h4>
          ...
          {/* Company */}
          <div className="col-span-1">
            <h4 className="text-base lg:text-lg font-semibold mb-4 lg:mb-6 text-white">Empresa</h4>
            <ul className="space-y-2 lg:space-y-3">
          ...
          {/* Resources */}
          <div className="col-span-1">
            <h4 className="text-base lg:text-lg font-semibold mb-4 lg:mb-6 text-white">Recursos</h4>
            <ul className="space-y-2 lg:space-y-3">
      ...
      <div className="bg-gradient-to-r from-slate-800 to-slate-700 border-t border-slate-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
          <div className="text-center mb-6 lg:mb-8">
            <h3 className="text-xl sm:text-2xl font-bold mb-3 lg:mb-4 animate-fade-in">Mantente Informado</h3>
            <p className="text-gray-300 max-w-2xl mx-auto animate-fade-in text-sm sm:text-base" style={{ animationDelay: '0.2s' }}>
              Suscríbete a nuestra newsletter para recibir las últimas noticias sobre ciberseguridad y nuestras soluciones
            </p>
          </div>
          
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-md mx-auto animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <Input 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
            {certifications.map((cert, index) => (
              <div key={index} className="flex items-center text-xs sm:text-sm text-green-400 transition-all duration-300 hover:scale-105 animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                <div className="w-2 h-2 bg-green-400 rounded-full mr-2 animate-gentle-bounce flex-shrink-0" style={{ animationDelay: `${index * 0.5}s` }}></div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex space-x-3 sm:space-x-4 order-1 md:order-2">
              <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110">
                <Linkedin className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
              </a>
              <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-blue-400 to-blue-500 rounded-full flex items-center justify-center hover:from-blue-500 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110">
                <Twitter className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
              </a>
              <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full flex items-center justify-center hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110">
