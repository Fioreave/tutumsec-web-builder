          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                className="w-6 h-6  pt-20 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110"
              >
