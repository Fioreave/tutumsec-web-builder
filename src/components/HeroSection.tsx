  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-blue-50 to-white px-6 py-20 flex items-center">
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-8 leading-[1.5] animate-slide-up">
          ¿Y si mañana un{' '}
          <span className="text-blue-500 relative group">
            ciberataque
            <span className="absolute left-0 w-full h-1 bg-blue-500 mt-2 transition-all duration-500 group-hover:scale-110" style={{ top: '100%', marginTop: '8px' }}></span>
          </span>
          <br />
          paraliza tu empresa?
        </h1>
        
        <p className="text-xl text-gray-700 mb-6 max-w-4xl mx-auto opacity-0 animate-fade-in leading-[1.5]" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
          {t('heroSubtitle')}
        </p>
        
        <p className="text-lg text-gray-600 mb-12 max-w-5xl mx-auto opacity-0 animate-fade-in leading-[1.5]" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
          {t('heroDescription')}
        </p>
