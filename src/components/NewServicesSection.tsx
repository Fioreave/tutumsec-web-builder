...
const NewServicesSection = () => {
  const services = [
    {
      title: "Consultoría estratégica en Ciberseguridad y transformación digital",
      benefit: "Diagnóstico integral + roadmap con quick-wins.",
      icon: Users
    },
    {
      title: "vCISO (CISO as a Service)",
      benefit: "Gobernanza estratégica, cuadros de mando, control presupuestario y decisiones basadas en datos.",
      icon: Shield
    },
    {
      title: "Auditoría Técnica + Compliance (NIS2, ENS, ISO 27001)",
      benefit: "Evaluamos tu estado real y definimos un plan de mejora. Evita sanciones y fortalece tu reputación. Pentesting para la visibilidad real de riesgos IT-OT.",
      icon: CheckCircle
    },
    {
      title: "SOC / MDR 24×7",
      benefit: "Detección y respuesta en tiempo real con SLA ≤ 15 minutos. Cobertura total sin ampliar plantilla.",
      icon: Eye
    },
    {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 animate-slide-up leading-relaxed">
            Consultoría CISO, auditoría y detección 24/7 para proteger y hacer crecer tu negocio
          </h2>
        </div>
