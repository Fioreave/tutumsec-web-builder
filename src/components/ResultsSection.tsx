  ...
  const results = [
    {
      ...
      suffix: "%",
      title: t("results.card1.title"),
      subtitle: t("results.card1.subtitle"),
      gradient: "from-blue-900 to-black",
    },
    {
      end: 22,
      suffix: "%",
      title: t("results.card2.title"),
      subtitle: t("results.card2.subtitle"),
      gradient: "from-blue-950 to-blue-800",
    },
    {
      end: 10,
      prefix: "+",
      title: t("results.card3.title"),
      subtitle: t("results.card3.subtitle"),
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="text-xl text-gray-600 italic">{t("results.quote")}</p>
          </div>
