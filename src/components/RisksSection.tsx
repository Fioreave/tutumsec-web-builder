      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="transform transition-all duration-700 hover:translate-x-2">
            <h2 className="text-4xl lg:text-5xl font-bold mb-8 transition-colors duration-500 hover:text-blue-300">
              ¿Por qué tu empresa{' '}
              <span className="relative group">
                sigue expuesta?
                <svg className="absolute -bottom-2 left-0 w-full h-3 transition-all duration-500 group-hover:scale-105" viewBox="0 0 300 12" fill="none">
          ...
          <div className="space-y-8">
            {risks.map((risk, index) => (
              ...
              >
                <h3 className="text-xl font-semibold mb-2 text-blue-300 transition-colors duration-300 hover:text-blue-200">
                  {risk.title}
                </h3>
