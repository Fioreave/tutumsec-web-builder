        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => {
            ...
            return (
              <div 
                key={index}
                className="bg-gray-400 p-8 rounded-2xl text-white relative group hover:bg-gray-500 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 animate-fade-in cursor-pointer overflow-hidden"
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 bg-blue-500 rounded-lg mb-6 flex items-center justify-center group-hover:bg-white group-hover:text-blue-500 transition-all duration-500 transform group-hover:rotate-6 group-hover:scale-105">
