...
const beneficios = [
  "Menos superficie de ataque en planta.",
  "Respuesta más rápida ante anomalías.",
  "Paradas minimizadas y recuperación priorizada.",
];
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            >
              ...
              <p className="mt-4 font-medium text-lg leading-7 text-slate-700">
                Enfoque integral para reducir riesgo OT y mantener la
                producción.
              </p>
            </motion.div>
            ...
            >
              {[
                {
                  t: "Descubrimiento e inventario OT",
                  d: "Identificación automática de activos y redes industriales.",
                  href: "/descubrimiento-ot",
                  pos: "left-2",
                },
                {
                  t: "Zonas y conductos",
                  d: "Endurecimiento y parches en paradas planificadas.",
                  href: "/zonas-y-conductos",
                  pos: "left-1",
                },
                {
                  t: "Detección en red industrial",
                  d: "Casos MITRE ATT&CK for ICS para supervisión avanzada.",
                  href: "/deteccion-ot",
                  pos: "center",
                },
                {
                  t: "DRP y restauración",
                  d: "Pruebas de recuperación guiadas por seguridad/producción.",
                  href: "/drp-industrial",
                  pos: "right-1",
                },
                {
                  t: "Gobierno IEC 62443",
                  d: "Programa de gobierno y formación a operaciones.",
