...
const faqs = [
  {
    question: "¿Tengo que cambiar toda mi tecnología?",
    answer:
      "No. Empezamos con lo que ya usas y solo añadimos lo imprescindible. ",
  },
  {
    question: "¿Cuándo veo resultados?",
    answer:
      "En el primer bloque de 4-6 semanas: controles básicos bien puestos y lista de mejoras. ",
  },
  {
    question: "¿Formáis al equipo?",
    answer:
      "Sí. Sesiones breves, recordatorios y pruebas sencillas para crear hábitos. ",
  },
];

const beneficios = [
  "Menos incidentes y menos paradas. ",
  "Cumples NIS2/ISO 27001 con pasos claros y evidencias. ",
  "Todo documentado: menos dependencia de “héroes”.",
  "Más confianza de clientes, auditores y aseguradoras. ",
];
        ...
        */}
          ...
          <div className="mx-20 max-w-4xl text-left relative">
            <h1 className="text-4xl lg:text-5xl font-medium text-white mb-2 leading-tight animate-slide-up pb-2">
              Ciberseguridad para PYMEs: orden, control y resultados{" "}
            </h1>
            <h2 className="text-2xl lg:text-2xl text-white mb-6 leading-tight  animate-slide-up pb-2">
              Orden, prioridades claras y evidencias para dirección: menos
              incidentes y tiempos de recuperación reales.
            </h2>
            <div
                ...
                <div className="p-6">
                  <ul className="list-disc list-outside pl-6 space-y-2 leading-relaxed text-slate-700 marker:text-blue-500">
                    <li>
                      ...
                      , demasiadas herramientas sueltas.
                    </li>
                    <li>
                      <span className="font-medium text-slate-900">
                        Dependencia
                      </span>{" "}
                      de una persona o proveedor para “todo”.
                    </li>
                    <li>
                      <span className="font-medium text-slate-900">
                        Copias sin probar
                      </span>{" "}
                      y dudas sobre cómo recuperarse a tiempo.
                    </li>
                    <li>
                      <span className="font-medium text-slate-900">
                        Cumplimiento difuso
                      </span>{" "}
                      (NIS2/ISO 27001) y poco foco en evidencias.
                    </li>
                    <li>
                      <span className="font-medium text-slate-900">
                        Exposición creciente
                      </span>{" "}
                      por correo, nube y accesos remotos.
                    </li>
                  </ul>
                </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            >
              {[
                {
                  t: "vCISO",
                  d: "Gobierno y plan por impacto (4–6 semanas).",
                  href: "/descubrimiento-ot",
                  pos: "left-2",
                },
                {
                  t: "Audit-to-Comply",
                  d: "Auditoría ofensiva + acciones para NIS2/ISO 27001.",
                  href: "/zonas-y-conductos",
                  pos: "left-1",
                },
                {
                  t: "MDR 24/7",
                  d: "Detección y respuesta sin jerga, con informes claros. ",
                  href: "/deteccion-ot",
                  pos: "center",
                },
                {
                  t: "Recuperación",
                  d: "Copias inmutables, una copia aislada y pruebas mensuales. ",
                  href: "/drp-industrial",
                  pos: "right-1",
                },
                {
                  t: "Personas",
                  d: "Formación breve y recordatorios para crear hábitos.",
