...
const beneficios = [
  "Menos paradas, más disponibilidad de servicios.",
  "Menos impacto en datos sensibles.",
  "Evidencias para auditoría y dirección.",
];
        ...
        */}
          ...
          <div className="mx-20 max-w-4xl text-left relative">
            <h1 className="text-4xl lg:text-5xl font-medium text-white mb-2 leading-tight animate-slide-up pb-2">
              Ciberseguridad para salud: pacientes y sistemas siempre
              disponibles{" "}
            </h1>
            <h2 className="text-2xl lg:text-2xl text-white mb-6 leading-tight  animate-slide-up pb-2">
              Ransomware y filtraciones son la norma; nuestra respuesta:
              prevención clara y recuperación ensayada
            </h2>
            <div
            ...
            <div className="grid items-center gap-10 md:grid-cols-2">
              ...
              <div>
                ...
                <h2 className="mt-3 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
                  El sector salud encabeza incidentes significativos en la UE;
                </h2>

                <p className="mt-6 text-lg leading-8 text-slate-700">
                  Ransomware (≈45%) y brechas de datos (≈28%).
                </p>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            >
              {[
                {
                  t: "vCISO sanitario",
                  d: "gobierno, riesgos y privacidad.",
                  href: "/descubrimiento-ot",
                  pos: "left-2",
                },
                {
                  t: "Hardening y segmentación",
                  d: "(IT/OT clínica).",
                ...
                {
                  t: "Copias + Pruebas",
                  d: "Copias inmutables + pruebas mensuales.",
                  href: "/deteccion-ot",
                  pos: "center",
                },
                {
                  t: "MDR 24×7",
                  d: "Con reglas clínicas y triage por criticidad.",
                  href: "/drp-industrial",
                  pos: "right-1",
                },
                {
                  t: "Plan de recuperación",
                  d: "por servicios: EMR, laboratorio, imagen, etc.",
          ...
          <div className="max-w-screen-xl  mx-auto relative">
            <div className="bg-gradient-to-r from-black via-blue-900 to-blue-800 rounded-[2rem] p-12 relative overflow-hidden mx-auto max-w-5xl">
              ...
              "
                ...
                <div className="flex flex-col sm:flex-row gap-4 pb-4 justify-left mb-4">
                  <Link
                ...
                "
                  ...
                  >
                    Solicita revisión de tus copias.{" "}
                  </Link>
                </div>
              </div>
              <img
