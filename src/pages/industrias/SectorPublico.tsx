...
const beneficios = [
  "Evidencias listas para auditorías y pliegos.",
  "Menos paradas y mejor servicio al ciudadano.",
  "Mayor control de terceros y contratos.",
];
        ...
        */}
          ...
          <div className="mx-20 max-w-4xl text-left relative">
            <h1 className="text-4xl lg:text-5xl font-medium text-white mb-2 leading-tight animate-slide-up pb-2">
              Ciberseguridad para sector público: servicio sin interrupciones
            </h1>
            <h2 className="text-2xl lg:text-2xl text-white mb-6 leading-tight  animate-slide-up pb-2">
              ENS como base, NIS2 en el horizonte y presión de incidentes:
              hacemos fácil cumplir, operar y demostrar.
            </h2>
            <div
            ...
            <div className="grid items-center gap-10 md:grid-cols-2">
              ...
              <div>
                ...
                <h2 className="mt-3 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
                  ENS (RD 311/2022) y la transposición NIS2 en curso, con
                  sanciones relevantes en el debate público;
                </h2>
                <p className="mt-6 text-lg leading-8 text-slate-700">
                  Proveedores ya muestran conformidad ENS.
                </p>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            >
              {[
                {
                  t: "Adecuación ENS",
                  d: "(medidas, políticas y evidencias).",
                  href: "/descubrimiento-ot",
                  pos: "left-2",
                },
                {
                  t: "vCISO público",
                  d: "Gobierno, riesgos, continuidad y formación.",
                  href: "/zonas-y-conductos",
                  pos: "left-1",
                },
                {
                  t: "MDR 24×7 ",
                  d: "Integrado con CSIRT/CCN.",
                  href: "/deteccion-ot",
                  pos: "center",
                },
                {
                  t: "Recuperación",
                  d: "Copias inmutables y simulacros periódicos.",
                  href: "/drp-industrial",
                  pos: "right-1",
                },
                {
                  t: "Gestión de proveedores",
                  d: "Y requisitos de seguridad. ",
                  href: "/drp-industrial",
                  pos: "right-1",
                },
              ].map((card, idx) => {
