...
import { CheckCircle, Users, Monitor, Factory, Wrench, Smartphone, Compass } from 'lucide-react';
...
const FormacionConcienciacion = () => {
  ...
  const solutionCards = [
    {
      ...
      description: 'Píldoras breves y accionables, con ejemplos reales del día a día (oficina, campo, planta).',
      deliverables: 'vídeos/carruseles, mini-quizzes, guía "1 página" por tema.'
    },
    {
      title: 'Phishing simulado con corrección guiada',
      description: 'Campañas periódicas según riesgo del área; informes con métricas y plan de mejora por equipo.',
      deliverables: 'informe ejecutivo, métricas (tasa de clics, reportes), recomendaciones.'
    },
    {
      title: 'Talleres por rol y casos reales',
      description: 'Sesiones presenciales o por videollamada, con ejercicios prácticos, role-play de incidentes y "qué hacer si…".',
      deliverables: 'material de apoyo, pósters/infografías, checklist de buenas prácticas.'
    },
    {
      title: 'Coaching de dirección (comité/gerencia)',
      description: 'Gobernanza, indicadores y decisiones de negocio: cómo priorizar, cómo responder y qué exigir a TI/partners.',
      deliverables: 'briefing trimestral, guía de decisiones, hoja de ruta de cultura.'
    }
  ];
  ...
  const roleItineraries = [
    {
      ...
      deliverables: 'Guía de decisiones (1 pág.), dashboard de cultura, briefing trimestral.'
    },
    {
      ...
      deliverables: 'Fichas de proceso, checklist de equipo, plantilla de reporte.'
    },
    {
  ...
  const faqs = [
    {
      ...
      answer: 'Ambas. Combinamos presencial/videollamada con contenido SaaS. En un futuro próximo integraremos LMS.'
    },
    {
      question: '¿Está adaptado a Barcelona/Girona/Cataluña/Andorra?',
      answer: 'Sí. Adaptamos lenguaje, ejemplos y calendario. Disponemos de contenidos en ES y opción CA.'
    },
    {
      question: '¿Cuánto tiempo requiere el programa?',
      answer: 'Las píldoras son de 10 minutos; talleres y simulaciones se planifican para no interrumpir la operación.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Lo gestionamos externamente. Entregamos informes válidos para auditoría (NIS2/ISO/ENS).'
    }
  ];
  ...
  const serviceStructuredData = {
    ...
    "serviceType": "Programa de formación y concienciación en ciberseguridad (awareness NIS2)",
    "provider": {
      "@type": "Organization",
      "name": "TutumSec"
    },
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <section className="mb-16">
            ...
            <div className="mt-6 p-4 bg-muted rounded-lg">
              <p className="text-sm">
                <strong>Nota legal/compliance:</strong> Incluimos informe de formación apto para evidencias de auditoría (NIS2/ISO 27001).
              </p>
            </div>
          </section>
                ...
                <AccordionItem key={index} value={`item-${index}`}>
                  <AccordionTrigger className="text-left">
                    <div className="flex items-center">
                      {role.icon}
                      <span className="ml-3 text-lg font-semibold">{role.title}</span>
                    </div>
                  </AccordionTrigger>
                  <AccordionContent>
                    <div className="pl-9">
                      <p className="mb-4"><strong>Objetivo:</strong> {role.objective}</p>
                      <div className="mb-4">
                      ...
                      <p><strong>Entregables:</strong> {role.deliverables}</p>
                    </div>
                  </AccordionContent>
                </AccordionItem>
              ))}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                <ul className="space-y-3">
                  ...
                  <li><strong>Comunicación:</strong> y soporte continuo.</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Checklist "Cultura de Seguridad en 30 días"</CardTitle>
                  <CardDescription>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
              ...
              <Button variant="outline" size="lg">Descargar Kit Anti-Phishing</Button>
            </div>
          </section>
          ...
          <section className="mb-16 bg-muted p-8 rounded-lg text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-4">
              ...
              <Button variant="outline" size="lg">Descarga el Kit Anti-Phishing</Button>
            </div>
          ...
          <section className="mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Button size="lg">Solicitar diagnóstico gratuito</Button>
              <Button variant="outline" size="lg">Solicitar presupuesto</Button>
            </div>
